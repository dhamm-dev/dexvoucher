...
const Navbar = {
  /** Daftar menu utama */
  MENUS: [
    { label: 'Beranda', href: ROOT + '/index.html' },
    { label: 'Game', href: ROOT + '/index.html#games' },
    { label: 'Tentang', href: ROOT + '/pages/user/about.html' }
  ],
      ...
      <nav class="navbar" role="navigation" aria-label="Navigasi utama">
        <div class="navbar-inner">
          ...
          <div class="navbar-actions">
            ...
            <a href="${ROOT}/pages/user/cart.html" class="navbar-cart" aria-label="Keranjang belanja">
              <img class="icon-img" src="${ROOT}/assets/images/icons/checkout.png" alt="" style="width:20px;height:20px">
            ...
            ${isLoggedIn ? `
              <div class="navbar-user" id="navbar-user">
                ...
                <div class="navbar-dropdown" id="user-dropdown">
                  <a href="${ROOT}/pages/user/profile.html"><img class="icon-img" src="${ROOT}/assets/images/icons/Profil.png" alt="" style="width:16px;height:16px"> Profil</a>
                  <a href="${ROOT}/pages/user/history.html"><img class="icon-img" src="${ROOT}/assets/images/icons/transaction.png" alt="" style="width:16px;height:16px"> Riwayat</a>
                  <a href="${ROOT}/pages/user/settings.html"><img class="icon-img" src="${ROOT}/assets/images/icons/setting.png" alt="" style="width:16px;height:16px"> Pengaturan</a>
                  <div class="divider"></div>
                  <button id="logout-btn" type="button">🚪 Logout</button>
                </div>
              </div>
            ` : `
              <a href="${ROOT}/pages/user/login.html" class="btn btn-primary btn-sm">Masuk</a>
            `}
          </div>
        </div>
      </nav>
